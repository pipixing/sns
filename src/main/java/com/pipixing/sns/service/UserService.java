...
import com.pipixing.sns.dao.LoginTicketDAO;
import com.pipixing.sns.dao.UserDAO;
import com.pipixing.sns.model.LoginTicket;
...
public class UserService {
    ...
    public Map<String,String > register(String username,String password){
        ...
        user.setPassword(SnsUtil.MD5(password + user.getSalt())); // 密码加salt再用MD5加密，安全性更高
